...
//    private Heros heros;
//    
////    public Tentacule(Image imgHaut, Image imgBas) {
...
////        //img = this.imgHaut;
////    }
////    public Tentacule(Mechants type){
////        if(type.VANILLE.equals(type)){
////        this(Toolkit.getDefaultToolkit().getImage("crane.png"), Toolkit.getDefaultToolkit().getImage("crane.png"));}
////    
////    }
//    
//    @Override
